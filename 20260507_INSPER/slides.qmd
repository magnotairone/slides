...
## VERIFICAR Rate of Convergence of Empirical Probabilities{.smaller}

**Proposition 3 (Leonardi & Severino, 2025)**: 
...
eventually almost surely as $n \to \infty$, where $N(a_{W^\prime})$ is the number of occurrences of configuration $a_{W^\prime}$.


*  The proof is based on the Law of the Iterated Logarithm (LIL) for stationary polynomial mixing processes (Oodaira & Yoshihara, 1971), which provides tighter bounds than simple ergodicity.
