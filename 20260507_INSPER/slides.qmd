...
Applying the logarithm and taking into account the number of occurrences of each configuration in the sample, we can rewrite the above as
$$
...
with $|G(v)|$ denoting the cardinal of the set $G(v)$ and $\lambda_n$ being a non-negative decreasing seqeuence.
